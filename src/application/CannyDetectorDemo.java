...
public class CannyDetectorDemo {
    ...
    public CannyDetectorDemo(String[] args) {
        String imagePath = args.length > 0 ? args[0] : OpenCVTests.file.path;
    ...
    private void addComponentsToPane(Container pane, Image img) {
        ...
        JLabel originalLabel = new JLabel(new ImageIcon(HighGui.toBufferedImage(src)));
        pane.add(originalLabel, BorderLayout.EAST);
        imgLabel = new JLabel(new ImageIcon(img));
        pane.add(imgLabel, BorderLayout.WEST);
    }
    private void update() {
